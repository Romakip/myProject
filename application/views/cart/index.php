...
<table class="table">
    ...
    <tr>    
        ...
        <td><p id="CountId<?= $product['id']?>"><?= $product['product_count']?> </p><button class="minusCount" data-priceId="<?=$product['price']?>" data-productId="<?= $product['id'] ?>">-</button><button class="plusCount" data-priceId="<?=$product['price']?>" data-productId="<?= $product['id'] ?>">+</button></td>
        <td><?= $product['price'] ?> </td>
